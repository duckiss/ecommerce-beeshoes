...
//    public static String vnp_IpAddr = "0:0:0:0:0:0:0:1";
    ...
    public static String vnp_ReturnUrl = "http://beeshoes-frontend-service:80/payment/payment-success";
    public static String vnp_ReturnUrlBuyOnline = "http://beeshoes-frontend-service:80/client/payment/payment-success";
